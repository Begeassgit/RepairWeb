...
public interface UserDao {
    @Select("SELECT user_username, user_company, user_department FROM maintenance_db.user_t WHERE (user_username=#{username} AND user_password=#{password})")
    User checkLogin(String username, String password);

    @Insert("INSERT INTO maintenance_db.user_t(user_username,user_password,user_phone,user_company,user_address,user_info,user_department) VALUES (#{user_username},#{user_password},#{user_phone}," +
